      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" action='{{ route('update_serve', $serve->id )}}' method='POST' enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" onchange='regfun()'  class="form-control" id="name"
                            placeholder="أدخل الإسم" value="{{$serve->name}}" >
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control">{{$serve->description}}</textarea>
                        @error('description')
                            <div class="alert alert-danger mt-3">{{ $message }}</div>
                        @enderror
                    </div>
